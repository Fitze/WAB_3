...
%\color{black}
	...
	\chapter{Technologien und Verfahren}\label{chap:technologien-und-verfahren}
		...
		\section{Schlüsselaustausch}
			Für die sichere Kommunikation ist ein sicherer Schlüsselaustausch die Ausgangsbasis um Angriffe zu verhindern. \glqq Hierbei ist der geschützte Austausch geheimer Schlüssel symmetrischer Kryptosysteme von Interesse.\grqq\footcite[Vgl.][S. 437]{Eckert2013}
...
%				\footcite[][S. 65]{Schwenk}			
				%Vorteile
				Der Vorteil von \ac{S/MIME} liegt darin, \glqq dass Verschlüsselung und Signatur genauso einfach zu bedienen sind, wie z.B. [..] das Anfügen eines Attachments\grqq\footcite[Vgl.][S. 61]{Schwenk}. Außerdem wird \ac{S/MIME} durch viele Browser by Default unterstützt.\footcite[Vgl.][]{Duevel}
...
%			Daher wird dieser Schlüssel auch als Secure Entry Point bezeichnet.
	...
	\chapter{E-Mail-Sicherheit in der Praxis}\label{chap:e-mail-sicherheit-in-der-praxis}
		...
		\label{sec:nwa}
			Die nachfolgende Nutzwertanalyse bewertet eine Auswahl von E-Mail-Anbietern anhand ihrer Umsetzung von sicherheitsrelevanter Technologien wie bspw. \ac{TLS}, \ac{PGP} oder Verfahren wie \ac{DNSSEC} bzw. \ac{DANE}.
