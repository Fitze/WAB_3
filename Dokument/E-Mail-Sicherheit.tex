...
%			Daher wird dieser Schlüssel auch als Secure Entry Point bezeichnet.
	...
	\chapter{E-Mail-Sicherheit in der Praxis}
		...
		\subsubsection{Vertraulichkeit}		
			...
			\color{darkred}
				Die Behauptung, dass Google das seit 2004 einsetzt muss noch belegt werde\dots (Daniel)
			\color{black}
		...
		\subsubsection{Zusammenfassung}
			...
			\label{subsubsec:posteo}
				...
				\paragraph{Integrität}
					...
					Momentan bereitet aber die sichere Speicherung des privaten Schlüssels des Nutzers noch Probleme, so dass nciht feststeht zuwelchem Zeitpunkt diese Funktion zur Verfügung se´tehen wird.\footcite[Vgl.]{Posteo2013c}
					Über die Verschlüsselungsmöglichkeiten per \ac{PGP} und \ac{S/MIME} und die damit verbundenen Vor- und Nachteile wird auf der Webseite von Posteo gut informiert.
				...
				\paragraph{Authentizität}
				So war Posteo einer der ersten\footnote{Auch Mailbox.org setzt seit Mai 2014 \ac{DANE} ein,\cite[Vgl.]{Mailbox2014a} so dass nicht zweifelsfrei belegt werden kann, wer diese Funktion zuerst genutzt hat.} Anbieter, der zur Authentifizierung seiner Server \ac{DANE} umgesetzt hat.\footcite[Vgl.]{Zivadino14-5}\medskip\\
			...
			Mittels den oben beschriebenen Angriffsszenarien kann der Angreifer eine Nachricht verschicken und der Empfänger geht fälschlicherweise davon aus, dass die Nachricht unverändert wurde. \footcite[o.S.]{Neumann2013b}\medskip\\
			...
			Er empfiehlt eine standardmäßige Ende-zu-Ende-Verschlüsslung\footcite[Vgl.][S. 7]{Neumann2013a} \footcite{Neumann2013b, o. S.} sowie die Einhaltung der Vorgaben des Signaturgesetzes.\footcite[Vgl.][S. 4]{Neumann2013a}
