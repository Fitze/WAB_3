...
%			Daher wird dieser Schlüssel auch als Secure Entry Point bezeichnet.
	...
	\chapter{E-Mail-Sicherheit in der Praxis}
		...
		\label{sec:nwa}
			...
			Die Auswahl der Oberkriterien lehnt sich an die Datenschutz Schutzziele \textit{Vertraulichkeit und Integrität}, \textit{Authentizität} (\prettyref{sec:datensicherheit-einmaleins}) sowie \textit{sicherheitsrelevante Aspekte}. \medskip\\
			...
			Die Ergebnisse der entsprechenden Test-Protokolle (\prettyref{sec:anhang}) der ausgewählten E-Mail-Anbieter sind unter Berücksichtigung der zuvor beschriebenen Zielgruppe und Sicherheitsniveaus verglichen und bewertet wurden.\\
			...
			Die Bewertung der E-Mail-Anbieter erfolgt nachfolgend \prettyref{sec:provider-vergleich} textlich beschrieben und auf die relevanten Faktoren beschränkt.
