...
\color{black}
	...
	\label{chap:dns}
		...
		\begin{wrapfigure}{l}{0.55\textwidth}
			\centering
			\includegraphics[width=0.5\textwidth]{images/Baumstruktur_DNS.png}
...
%			Daher wird dieser Schlüssel auch als Secure Entry Point bezeichnet.
	...
	\chapter{E-Mail-Sicherheit in der Praxis}
		\section{Provider Vergleich}
			...
			Dieses Vorgehen erinnert an ein geschlossene Variante von \ac{DANE} (\prettyref{sec:dane}), welches ähnlich zur Sicherstellung der Authentizität verfährt.
		...
		\subsubsection{Zusammenfassung}
			...
			Diese Anbieter positionieren sich bewusst im Kontrast zu den großen Mailprovidern als Alternativen, die einen hohen Wert auf die Privatsphäre ihrer Kunden legen.
