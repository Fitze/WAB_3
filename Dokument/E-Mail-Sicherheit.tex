...
%\endgroup	
	...
	%\input{Kapitelvorlage_Datenschutz1x1}
...
\lfoot{Feller, Moy, Tran, Schünhoff - v0.5 \\ Datum}
...
%			Daher wird dieser Schlüssel auch als Secure Entry Point bezeichnet.
	...
	\chapter{E-Mail-Sicherheit in der Praxis}
		...
		%NWA - Vertraulichkeit			
			...
			Zertifikate werden müssen für Teilnehmer der Provider von deutschen \acp{CA} ausgestellt sein.\medskip\\
		%NWA - Integrität
			Die \textbf{Integrität} der E-Mail-Inhalte sind für EmiG-Provider von keiner großen Bedeutung.
			...
			Allerdings ist bspw. im \textit{Hilfe und Support} Bereich von T-Online generell keinerlei Hilfe zur Einrichtung von E2EE mittels PGP oder S/MIME zu finden.
			...
			Eine Information das es sich um Ende-zu-Ende-Verschlüsselung handelt ist dem Suchergebnis nicht zu entnehmen.\medskip\\
			%NWA - Authentizität
