	...
	\chapter{E-Mail-Sicherheit in der Praxis}
		...
		\subsubsection{Zusammenfassung}
			...
			\label{subsubsec:posteo}
				...
				Laut Angaben des Unternehmens verzeichnet das Unternehmen einen Nutzerzuwachs um mehr 100\% pro Jahr.\footcite[Vgl.]{Posteo2013b}
				Er probiert sich bewusst von den Konkurrenten abzusetzen durch das Angebot von innovativen Sicherheitsfunktionen.
				So war Posteo einer der ersten\footnote{Auch Mailbox.org hat fast zeitgleich \ac{DANE} eingesetzt, so dass nicht zweifelsfrei belegt werden kann, wer diese Funktion zuerst genutzt hat.} Anbieter, der zur Authentifizierung seiner Server auf \ac{DANE} gesetzt hat.\footcite[Vgl.]{Zivadino14-5}\medskip\\
